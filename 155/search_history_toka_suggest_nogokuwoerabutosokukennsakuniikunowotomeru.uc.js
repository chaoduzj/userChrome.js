...
// @version        2026/07/21 00:00  Bug 2051959 - Rename UrlbarInput._setValue to setValue
// @version        2026/06/21 00:00 remove dead code
  ...
  initpatch: function() {
    ...
    if (Services.prefs.getBoolPref("browser.search.widget.new", false)) {
      ...
      searchBar.addEventListener("mouseup", (event) => {
        ...
        searchBar.setValue(span.textContent, {valueIsTyped: true});
