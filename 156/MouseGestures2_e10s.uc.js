...
// @version        2025/08/18 Bug 1983422_linkTXT excludes alt if img is visible
      ...
      [
        ...
        ['', 'タブを複製',
         function(){ 
            ...
            gBrowser.moveTabTo(newTab, {tabIndex: orgTab.index + 1});
          } ],
        ...
        ['', '左側のタブをすべて閉じる', function(){ gBrowser.removeTabsToTheStartFrom(gBrowser.selectedTab); } ],
...
*/
        ...
        ['LDR', 'Reader Mode',
          function() {
            ...
            document.getElementById("reader-mode-button").dispatchEvent(event);
        }],
          ...
          */
          if (node.nodeType == node.TEXT_NODE) {
            ...
            text += " " + node.data;
                     ...
                     /*Bug 1983422 */ && node.checkVisibility()
